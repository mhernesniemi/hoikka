<script lang="ts">
  ...
  import { Toaster } from "@hoikka/core/admin/ui/sonner/index";
  ...
  import {
    ...
    getTheme,
    type Theme
  } from "@hoikka/core/admin/admin-theme.svelte";
  import { cn } from "@hoikka/core/shared/utils";
  import type { load as __lload } from "./layout.server.js";
  type LayoutData = Awaited<ReturnType<typeof __lload>>;
