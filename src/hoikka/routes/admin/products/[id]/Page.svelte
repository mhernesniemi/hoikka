<script lang="ts">
  ...
  import { translationsToMap, TRANSLATION_LANGUAGES } from "@hoikka/core/config/derived";
  ...
  import CategoryCombobox from "@hoikka/core/admin/CategoryCombobox.svelte";
  import ProductPicker from "@hoikka/core/admin/ProductPicker.svelte";
