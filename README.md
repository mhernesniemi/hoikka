...
- [Full-Text Search](https://hoikka-docs.vercel.app): client-side product cache with instant filtering, faceted search, and pagination
...
- [Categories](https://hoikka-docs.vercel.app): hierarchical category tree with breadcrumb navigation
- [Promotions](https://hoikka-docs.vercel.app): percentage and fixed discounts, coupon codes, automatic promotions, per-group and per-product targeting
- [B2B Pricing](https://hoikka-docs.vercel.app): customer groups with group-specific variant prices and tax exemptions
- [Inventory](https://hoikka-docs.vercel.app): stock tracking with timed reservations to prevent overselling
...
- [Wishlists](https://hoikka-docs.vercel.app): for both logged-in and guest users
- [Reviews](https://hoikka-docs.vercel.app): customer ratings with moderation and verified purchase badges
- [Content Pages](https://hoikka-docs.vercel.app): static pages for policies, FAQs, and more
- [Multi-Language](https://hoikka-docs.vercel.app): translation tables for products, categories, collections, facets, and pages
